...
async function Enjin2Module(moduleArg = {}) {
  var moduleRtn;
...
// include: /home/unwn/dev/unwn-vcv/unwn/enjin2/src/bindings/pre.js
/**
...
Module['MAXIMUM_MEMORY'] = 64 * 1024 * 1024; // 64MB max memory
...
};// end include: /home/unwn/dev/unwn-vcv/unwn/enjin2/src/bindings/pre.js
...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('enjin2.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('enjin2.wasm', import.meta.url).href;
}
